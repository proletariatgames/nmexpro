...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",51)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",52)
	this->localX = localX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",53)
	this->localY = localY;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",54)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",55)
	this->ctrlKey = ctrlKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",56)
	this->altKey = altKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",57)
	this->shiftKey = shiftKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",58)
	this->buttonDown = buttonDown;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",59)
	this->delta = delta;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",60)
	this->commandKey = commandKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",61)
...
::nme::events::Event MouseEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",66)
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::nme::display::InteractiveObject related,::nme::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",90)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",92)
	if (((targ != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",93)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",94)
	return result;
}
...
::String MouseEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",99)
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",76)
	int flags = inEvent->__Field(HX_CSTRING("flags"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",77)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",78)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",79)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",80)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/MouseEvent.hx",81)
	return evt;
}
