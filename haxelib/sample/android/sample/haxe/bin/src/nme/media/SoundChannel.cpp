...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",26)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",28)
	if (((sndTransform != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",29)
		this->nmeTransform = sndTransform->clone();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",33)
	this->nmeHandle = ::nme::media::SoundChannel_obj::nme_sound_channel_create(inSoundHandle,startTime,loops,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",35)
	if (((this->nmeHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",36)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",44)
	if (((bool((this->nmeHandle != null())) && bool(::nme::media::SoundChannel_obj::nme_sound_channel_is_complete(this->nmeHandle))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",46)
		this->nmeHandle = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",47)
		::nme::events::Event complete = ::nme::events::Event_obj::__new(::nme::events::Event_obj::SOUND_COMPLETE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",48)
		this->dispatchEvent(complete);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",50)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",53)
	return false;
}
...
Void SoundChannel_obj::stop( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",89)
...
double SoundChannel_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",99)
...
double SoundChannel_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",100)
...
double SoundChannel_obj::nmeGetPosition( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",101)
...
::nme::media::SoundTransform SoundChannel_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",106)
	if (((this->nmeTransform == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",107)
		this->nmeTransform = ::nme::media::SoundTransform_obj::__new(null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",111)
...
::nme::media::SoundTransform SoundChannel_obj::nmeSetTransform( ::nme::media::SoundTransform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",117)
	this->nmeTransform = inTransform->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",118)
	::nme::media::SoundChannel_obj::nme_sound_channel_set_transform(this->nmeHandle,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",120)
	return inTransform;
}
...
bool SoundChannel_obj::nmeCompletePending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",61)
...
Void SoundChannel_obj::nmePollComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",70)
		if (((::nme::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",73)
			Array< ::nme::media::SoundChannel > incomplete = Array_obj< ::nme::media::SoundChannel >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",75)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",75)
				int _g = (int)0;
				...
				while(((_g < _g1->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",75)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",77)
					if ((!(channel->nmeCheckComplete()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",78)
						incomplete->push(channel);
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/SoundChannel.hx",83)
