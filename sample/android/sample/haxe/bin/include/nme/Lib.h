...
class Lib_obj : public hx::Object{
	...
	public:
		...
		static Void create( Dynamic inOnLoaded,int inWidth,int inHeight,Dynamic inFrameRate,Dynamic inColour,Dynamic inFlags,Dynamic inTitle,Dynamic inPackage,::nme::display::BitmapData inIcon);
	...
	Dynamic &nme_post_ui_callback_dyn() { return nme_post_ui_callback;}
