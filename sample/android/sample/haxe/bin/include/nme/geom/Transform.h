...
class Transform_obj : public hx::Object{
	public:
		...
		Transform_obj();
		Void __construct(::nmex::display::DisplayObject inParent);

	public:
		static hx::ObjectPtr< Transform_obj > __new(::nmex::display::DisplayObject inParent);
		...
		::nmex::display::DisplayObject nmeObj; /* REM */ 
