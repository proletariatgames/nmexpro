...
#define INCLUDED_nmex_display_DisplayObject
...
class DisplayObject_obj : public ::nme::events::EventDispatcher_obj{
	...
	public:
		...
		::nmex::display::Graphics graphics; /* REM */ 
		...
		double tempX; /* REM */ 
		double tempY; /* REM */ 
		double tempScaleX; /* REM */ 
		double tempScaleY; /* REM */ 
		double tempAlpha; /* REM */ 
		virtual ::String toString( );
		Dynamic toString_dyn();

		virtual ::nmex::display::Graphics nmeGetGraphics( );
		...
		virtual ::nmex::display::DisplayObject nmeSetMask( ::nmex::display::DisplayObject inObject);
...
#endif /* INCLUDED_nmex_display_DisplayObject */ 
