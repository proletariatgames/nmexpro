...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",116)
	this->mTime = time;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",117)
	::haxe::Timer_obj::sRunningTimers->push(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",118)
	this->mFireAt = (::haxe::Timer_obj::GetMS() + this->mTime);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",119)
	this->mRunning = true;
}
;
	return null();
...
Void Timer_obj::stop( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",132)
		if ((this->mRunning)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",136)
			this->mRunning = false;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",137)
...
Void Timer_obj::nmeCheck( double inTime){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",171)
		if (((inTime >= this->mFireAt))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",175)
			hx::AddEq(this->mFireAt,this->mTime);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",176)
			this->run();
		}
	}
return null();
...
double Timer_obj::nmeNextWake( double limit){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",146)
	double now = (::haxe::Timer_obj::nme_time_stamp() * 1000.0);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",148)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",148)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",148)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",150)
			double sleep = (timer->mFireAt - now);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",152)
			if (((sleep < limit))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",154)
				limit = sleep;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",156)
				if (((limit < (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",156)
					return (int)0;
				}
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",166)
	return limit;
}
...
Void Timer_obj::nmeCheckTimers( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",185)
		double now = ::haxe::Timer_obj::GetMS();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",187)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",187)
			int _g = (int)0;
			Array< ::haxe::Timer > _g1 = ::haxe::Timer_obj::sRunningTimers;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",187)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",189)
				timer->nmeCheck(now);
			}
		}
	}
...
double Timer_obj::GetMS( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",196)
...
::haxe::Timer Timer_obj::delay( Dynamic f,int time){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",204)
	Dynamic f1 = Dynamic( Array_obj<Dynamic>::__new().Add(f));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",206)
	...
	Void run(){
{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",209)
			t->__get((int)0)->stop();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",210)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",208)
	t->__get((int)0)->run =  Dynamic(new _Function_1_1(t,f1));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",213)
...
double Timer_obj::stamp( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/haxe/Timer.hx",218)
