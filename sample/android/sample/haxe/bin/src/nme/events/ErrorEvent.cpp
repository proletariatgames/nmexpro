...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/ErrorEvent.hx",13)
	super::__construct(type,bubbles,cancelable,text);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/ErrorEvent.hx",14)
	this->errorID = id;
}
;
	return null();
...
::nme::events::Event ErrorEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/ErrorEvent.hx",19)
...
::String ErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/ErrorEvent.hx",25)
