...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",19)
	this->nmeTarget = (  (((target == null()))) ? ::nme::events::IEventDispatcher(hx::ObjectPtr<OBJ_>(this)) : ::nme::events::IEventDispatcher(target) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",20)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",26)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",27)
			this->nmeEventMap = ::Hash_obj::__new();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",28)
		Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",29)
		if (((list == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",31)
			list = Array_obj< ::nme::utils::WeakRef >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",32)
			this->nmeEventMap->set(type,list);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",35)
		::nme::events::Listener l = ::nme::events::Listener_obj::__new(listener,useCapture,priority);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",36)
...
Void EventDispatcher_obj::DispatchCompleteEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",46)
		::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",47)
...
bool EventDispatcher_obj::dispatchEvent( ::nme::events::Event event){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",53)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",54)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",55)
	if (((event->nmeGetTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",56)
		event->nmeSetTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",58)
	if (((event->nmeGetCurrentTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",59)
		event->nmeSetCurrentTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",61)
	Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(event->nmeGetType());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",62)
	bool capture = (event->nmeGetEventPhase() == ::nme::events::EventPhase_obj::CAPTURING_PHASE);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",64)
	if (((list != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",66)
		int idx = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",67)
		int length = list->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",68)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",68)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",68)
			while(((_g < length))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",68)
				int i = (_g)++;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",70)
				::nme::utils::WeakRef list_item = list->__get(idx);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",71)
				::nme::events::Listener listener = list_item->get();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",73)
				if (((listener == null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",74)
					list->splice(idx,(int)1);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",80)
					if (((listener->mUseCapture == capture))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",82)
						listener->dispatchEvent(event);
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",83)
						if ((event->nmeGetIsCancelledNow())){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",84)
							return true;
						}
					}
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",87)
					if (((bool((idx < list->length)) && bool((list_item != list->__get(idx)))))){
					}
					else{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",92)
						(idx)++;
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",96)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",99)
	return false;
}
...
Void EventDispatcher_obj::DispatchIOErrorEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",109)
		::nme::events::IOErrorEvent evt = ::nme::events::IOErrorEvent_obj::__new(::nme::events::IOErrorEvent_obj::IO_ERROR,null(),null(),null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",110)
		this->dispatchEvent(evt);
	}
return null();
}
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",116)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",117)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",118)
	Array< ::nme::utils::WeakRef > h = this->nmeEventMap->get(type);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",119)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",125)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",126)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",128)
		if ((!(this->nmeEventMap->exists(type)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",128)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",130)
		Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",131)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",131)
			int _g1 = (int)0;
			int _g = list->length;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",131)
				int i = (_g1)++;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",133)
				::nme::events::Listener li = list->__get(i)->get();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",134)
				if ((li->Is(listener,capture))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",136)
					list->splice(i,(int)1);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",137)
					return null();
				}
			}
		}
...
::String EventDispatcher_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",144)
...
bool EventDispatcher_obj::willTrigger( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",151)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",152)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",153)
