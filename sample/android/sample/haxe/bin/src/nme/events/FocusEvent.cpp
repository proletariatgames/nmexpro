...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",23)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",24)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",25)
	this->keyCode = keyCode;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",26)
...
::nme::events::Event FocusEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",31)
...
::String FocusEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/FocusEvent.hx",37)
