...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",172)
	this->mListner = inListener;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",173)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",174)
	this->mPriority = inPriority;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",175)
...
Void Listener_obj::dispatchEvent( ::nme::events::Event event){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",180)
		this->mListner(event);
	}
return null();
}
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/events/EventDispatcher.hx",186)
