...
Void Transform_obj::__construct(::nmex::display::DisplayObject inParent)
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",21)
...
hx::ObjectPtr< Transform_obj > Transform_obj::__new(::nmex::display::DisplayObject inParent)
...
::nme::geom::ColorTransform Transform_obj::nmeGetColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",31)
...
::nme::geom::ColorTransform Transform_obj::nmeSetColorTransform( ::nme::geom::ColorTransform inTrans){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",32)
...
::nme::geom::ColorTransform Transform_obj::nmeGetConcatenatedColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",33)
...
::nme::geom::Matrix Transform_obj::nmeGetConcatenatedMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",34)
...
::nme::geom::Matrix Transform_obj::nmeGetMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",35)
...
::nme::geom::Matrix Transform_obj::nmeSetMatrix( ::nme::geom::Matrix inMatrix){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",36)
...
::nme::geom::Rectangle Transform_obj::nmeGetPixelBounds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/geom/Transform.hx",37)
...
Dynamic Transform_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"nmeObj") ) { nmeObj=inValue.Cast< ::nmex::display::DisplayObject >(); return inValue; }
		break;
	case 11:
