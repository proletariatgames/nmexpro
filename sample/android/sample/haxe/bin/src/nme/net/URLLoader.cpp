...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",55)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",56)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",57)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",58)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",59)
	this->state = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",60)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",61)
	if (((request != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",62)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",73)
...
Void URLLoader_obj::load( ::nme::net::URLRequest request){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",92)
		this->state = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",93)
		::String pref = request->url.substr((int)0,(int)7);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",94)
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",96)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",97)
				::nme::utils::ByteArray bytes = ::nme::utils::ByteArray_obj::readFile(request->url);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",98)
				{
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
					switch((_switch_1)->GetIndex()){
						case 1: case 2: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",100)
							this->data = bytes->asString();
						}
						;break;
						default: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",102)
							this->data = bytes;
						}
					}
				}
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",108)
						this->onError(e);
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",109)
						return null();
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",111)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",115)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",116)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",117)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",121)
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",156)
...
Void URLLoader_obj::update( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",162)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",165)
			int old_state = this->state;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",166)
			int old_loaded = this->bytesLoaded;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",167)
			int old_total = this->bytesTotal;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",168)
			::nme::net::URLLoader_obj::nme_curl_update_loader(this->nmeHandle,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",169)
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",170)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::OPEN,null(),null()));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",174)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",175)
				this->dispatchEvent(::nme::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",179)
			int code = ::nme::net::URLLoader_obj::nme_curl_get_code(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",180)
			if (((this->state == (int)3))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",181)
				if (((code < (int)400))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",184)
					::nme::utils::ByteArray bytes = ::nme::net::URLLoader_obj::nme_curl_get_data(this->nmeHandle);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",185)
					{
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
						switch((_switch_2)->GetIndex()){
							case 1: case 2: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",187)
								this->data = (  (((bytes == null()))) ? ::String(HX_CSTRING("")) : ::String(bytes->asString()) );
							}
							;break;
							default: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",189)
								this->data = bytes;
							}
						}
					}
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",192)
					this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",197)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",198)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",199)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",202)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",204)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",205)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",206)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",79)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",85)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",130)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",139)
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",142)
			::nme::net::URLLoader_obj::nme_curl_process_loaders();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",143)
			::List oldLoaders = ::nme::net::URLLoader_obj::activeLoaders;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",144)
			::nme::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",145)
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",147)
					loader->update();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",148)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLLoader.hx",149)
