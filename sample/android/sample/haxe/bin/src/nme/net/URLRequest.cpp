...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",24)
	if (((inURL != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",25)
		this->url = inURL;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",26)
	this->verbose = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",27)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",28)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",29)
	this->authType = (int)0;
}
;
	return null();
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",35)
		this->authType = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",36)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",42)
		this->authType = (int)2;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/net/URLRequest.hx",43)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
