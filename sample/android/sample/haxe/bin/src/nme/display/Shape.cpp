...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/display/Shape.hx",9)
	super::__construct(::nmex::display::DisplayObject_obj::nme_create_display_object(),HX_CSTRING("Shape"));
}
;
	return null();
}
