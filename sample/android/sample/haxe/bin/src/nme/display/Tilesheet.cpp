...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/display/Tilesheet.hx",48)
	this->nmeBitmap = inImage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/display/Tilesheet.hx",52)
...
Void Tilesheet_obj::addTileRect( ::nme::geom::Rectangle rectangle,::nme::geom::Point centerPoint){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/display/Tilesheet.hx",72)
...
Void Tilesheet_obj::drawTiles( ::nmex::display::Graphics graphics,Array< double > tileData,Dynamic __o_smooth,Dynamic __o_flags){
bool smooth = __o_smooth.Default(false);
int flags = __o_flags.Default(0);
	HX_SOURCE_PUSH("Tilesheet_obj::drawTiles");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/display/Tilesheet.hx",170)
