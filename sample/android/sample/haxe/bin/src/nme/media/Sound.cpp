...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",27)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",28)
	this->bytesLoaded = this->bytesTotal = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",29)
	this->nmeLoading = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",30)
	if (((stream != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",31)
...
Void Sound_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",37)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",38)
			::nme::media::Sound_obj::nme_sound_close(this->nmeHandle);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",39)
		this->nmeHandle = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",40)
		this->nmeLoading = false;
	}
return null();
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",46)
		this->bytesLoaded = this->bytesTotal = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",47)
		this->nmeHandle = ::nme::media::Sound_obj::nme_sound_from_file(stream->url,forcePlayAsMusic);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",48)
		if (((this->nmeHandle == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",49)
			hx::Throw ((HX_CSTRING("Could not load:") + stream->url));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",54)
			this->nmeLoading = true;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",55)
			this->nmeLoading = false;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",56)
...
Void Sound_obj::nmeCheckLoading( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",62)
		if (((bool(this->nmeLoading) && bool((this->nmeHandle != null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",65)
			Dynamic status = ::nme::media::Sound_obj::nme_sound_get_status(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",66)
			if (((status == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",67)
				hx::Throw (HX_CSTRING("Could not get sound status"));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",68)
			this->bytesLoaded = status->__Field(HX_CSTRING("bytesLoaded"));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",69)
			this->bytesTotal = status->__Field(HX_CSTRING("bytesTotal"));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",70)
			this->nmeLoading = (this->bytesLoaded < this->bytesTotal);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",71)
			if (((status->__Field(HX_CSTRING("error")) != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",72)
...
Void Sound_obj::nmeOnError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",81)
		this->dispatchEvent(::nme::events::IOErrorEvent_obj::__new(::nme::events::IOErrorEvent_obj::IO_ERROR,true,false,msg,null()));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",82)
		this->nmeHandle = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",83)
		this->nmeLoading = true;
	}
return null();
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",89)
		this->nmeCheckLoading();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",90)
		if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",91)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",94)
...
::nme::media::ID3Info Sound_obj::nmeGetID3( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",105)
	this->nmeCheckLoading();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",106)
	if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",107)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",108)
	::nme::media::ID3Info id3 = ::nme::media::ID3Info_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",109)
	::nme::media::Sound_obj::nme_sound_get_id3(this->nmeHandle,id3);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",110)
	return id3;
}
...
bool Sound_obj::nmeGetIsBuffering( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",116)
	this->nmeCheckLoading();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",117)
...
double Sound_obj::nmeGetLength( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",123)
	if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",124)
		return (int)0;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/media/Sound.hx",125)
