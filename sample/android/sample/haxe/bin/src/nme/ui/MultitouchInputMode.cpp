...
::nme::ui::MultitouchInputMode MultitouchInputMode_obj::GESTURE;

::nme::ui::MultitouchInputMode MultitouchInputMode_obj::NONE;

::nme::ui::MultitouchInputMode MultitouchInputMode_obj::TOUCH_POINT;
...
Dynamic MultitouchInputMode_obj::__Field(const ::String &inName)
{
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("nme.ui.MultitouchInputMode"), hx::TCanCast< MultitouchInputMode_obj >,sStaticFields,sMemberFields,
