...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",31)
	this->font = in_font;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",32)
	this->size = in_size;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",33)
	this->color = in_color;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",34)
	this->bold = in_bold;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",35)
	this->italic = in_italic;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",36)
	this->underline = in_underline;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",37)
	this->url = in_url;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",38)
	this->target = in_target;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",39)
	this->align = in_align;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",40)
	this->leftMargin = in_leftMargin;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",41)
	this->rightMargin = in_rightMargin;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",42)
	this->indent = in_indent;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,1,1/nme/text/TextFormat.hx",43)
