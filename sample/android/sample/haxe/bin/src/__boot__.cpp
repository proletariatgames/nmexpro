...
::nmex::NXEvent_obj::__register();
::nme::events::ErrorEvent_obj::__register();
::nme::events::TextEvent_obj::__register();
::nme::system::Capabilities_obj::__register();
::nmex::GameCenter_obj::__register();
...
::nmex::display::Graphics_obj::__register();
...
::nmex::display::DisplayObject_obj::__register();
...
::nme::JNIMethod_obj::__register();
::nme::JNI_obj::__register();
...
::Reflect_obj::__boot();
::nmex::display::Graphics_obj::__boot();
...
::nmex::GameCenter_obj::__boot();
::nme::system::Capabilities_obj::__boot();
::nme::events::TextEvent_obj::__boot();
::nme::events::ErrorEvent_obj::__boot();
::nmex::NXEvent_obj::__boot();
