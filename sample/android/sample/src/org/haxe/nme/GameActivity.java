...
public class GameActivity extends Activity  implements AdListener {
    ...
    protected void onCreate(Bundle state) {
        ...
        */
        ...
        //AppRater.showRateDialog(mContext, null);
    ...
    static public byte [] getResource(String inResource) {
           ...
           Log.i("GameActivity","Get resource------------------>" + inResource);
           try {
    ...
    static public int getMusicHandle(String inFilename){
       ...
       String[] name = inFilename.split("\\.");
       Log.v("GameActivity","Get music handle ------@@@@" + name[0]);
       inFilename = name[0];
       Log.v("GameActivity","Get music handle ------" + inFilename);
    ...
    {
       Log.i("GameActivity","playMusic -----" + inResourceID);
   ...
   //adwhirl
//   static public void showAd(final String id, final int x, final int y,final int size) {
//	   
//		activity.runOnUiThread(new Runnable() {
//			public void run() {
//				
//				String adWhirlSDKID = id;
//				
//				AdWhirlTargeting.setTestMode(true);
//
//				AdWhirlLayout adWhirlLayout = new AdWhirlLayout(activity, adWhirlSDKID);
//				
